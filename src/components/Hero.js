    ...
    <div className='relative bg-gradient-to-r from-primary to-[#2E94B9] overflow-hidden'>
       <div className='container mx-auto'>
            <div className='min-h-[65vh] flex mobile:flex-col tablet:flex-col justify-evenly items-center spa'>
                <div className='mobile:w-[300px] tablet:w-[300px] laptopsm:w-[550px] w-[500px] h-[400px] mx-20 rounded-2xl bg-gradient-to-t from-primary to-[#2E94B9] ring-8 ring-white shadow-2xl z-50'>
                    {/* <div className='w-full h-[45px] rounded-t bg-[#D1D1D1] flex justify-center items-center'></div> */}
                    <div className='flex flex-col justify-center items-center mt-8'>
                        <div className='text-[32px] mobile:text-[25px] text-center text-white font-poppins'>Simple &</div>
                        <div className='text-[32px] mobile:text-[25px] text-center text-white font-poppins'>hassle-free way</div>
                        <div className='text-[32px] mobile:text-[25px] text-center text-white font-poppins'>to find a car.</div>
                        ...
                        <div className='text-[16px] text-white font-poppins text-center py-3 px-6'>We have great cars, good prices & outstanding services.</div>
                        <div className='bg-btnPrimary hover:bg-btnSecondary duration-300 cursor-pointer rounded flex justify-center items-center px-14 py-[10px] mt-10'>
