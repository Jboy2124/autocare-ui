        ...
        <div className='relative min-h-[70vh] bg-white'>
          <div className='container mx-auto flex flex-col justify-evenly items-center'>
            <div className='w-full h-[65px] flex flex-col justify-center items-center mt-20'>
                ...
                <div className='text-[20px] text-gray-600 font-poppins text-center'>Cars that's Affordable, High-Tech & Value for the money that you can buy today!</div>
            </div>
            <div className='grid mobile:grid-cols-1 tablet:grid-cols-2 laptopsm:grid-cols-2 laptop:grid-cols-3 desktop:grid-cols-4 gap-3 place-items-center h-full desktop:h-[45vh] py-10'>
              {
                featCars.map(items => {
                  return(
